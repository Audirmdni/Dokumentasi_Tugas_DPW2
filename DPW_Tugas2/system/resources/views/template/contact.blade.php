...
<body>
    ...
    <section class="banner-bottom py-5">
        <div class="container py-md-5">
            <h3 class="title-wthree mb-lg-5 mb-4 text-center">Contact</h3>
            <div class="row contact_information">
                    ...
                    <div class="contact_right p-lg-5 p-4">
                        <form action="#" method="post">
                            ...
                            <div class="field-group">
                                ...
                                <div class="content-input-field">
                                    <input name="text1" id="text1" type="email" value=""
                            ...
                            <div class="field-group">
                                ...
                                <div class="content-input-field">
                                    <input name="text1" id="text3" type="text" value=""
                ...
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        ...
                        <p class="cont-wthree-para mb-3 text-capitalize">for general queries, including property Sales
                            and constructions, please email us at <a
                ...
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
                        ...
                        <p class="cont-wthree-para mb-3 text-capitalize">we are ready to help! if you have any queries
                            or issues, contact us for support <label>+12 388 455 6789</label>.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mt-lg-4 contact-inn-w3pvt">
                    <div class="mt-5 information-wthree">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-4">
                    <ul class="footer_wthree_gridf_list">
                        ...
                        <li>
                            <a href="{{ url('about') }}"><span class="fa fa-angle-right" aria-hidden="true"></span>
                                About</a>
                        </li>
                        <li>
