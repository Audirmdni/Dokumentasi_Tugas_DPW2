        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="{{ url('home') }}/"><span class="log-w3pvt">AU</span>Store</a> <label
        ...
        <div class="container py-5">
            ...
            <div class="row shop-wthree-info text-center">
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ url('public') }}/images/b5.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ url('public') }}/images/b6.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ url('public') }}/images/b8.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ url('public') }}/images/b7.jpg" class="img-fluid" alt="">
        ...
        <div class="container py-md-5">
            <div class="row">
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-sm-4 mt-3">
                    <ul class="footer_wthree_gridf_list">
                        <li>
                            <a href="login.html"><span class="fa fa-angle-right" aria-hidden="true"></span> Login
                            </a>
                        </li>
