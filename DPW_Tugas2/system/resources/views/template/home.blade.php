        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="index.html"><span class="log-w3pvt">AU</span>Store</a> <label
                                class="sub-des">HAPPY SHOPING!</label></h1>
                    </div>

                    <div class="forms ml-auto">
                        <a href="{{ url('login') }}" class="btn"><span class="fa fa-user-circle-o"></span> Sign
                            In</a>
                        <a href="{{ url('register') }}" class="btn"><span class="fa fa-pencil-square-o"></span> Sign
                            Up</a>
                    </div>
                </div>
                    ...
                    <div class="search-form ml-auto">
                        <div class="form-w3layouts-grid">
                            <form action="#" method="post" class="newsletter">
                                ...
                                <button class="form-control btn" value=""><span
        ...
        <div class="banner-wthree-info container">
            <div class="row">
                <div class="col-lg-5 banner-left-info">
                    ...
                    <a href="{{ url('') }}" class="btn shop">Shop Now</a>
                </div>

                <div class="col-lg-7 banner-img">
                    <img src="{{ url('public') }}/images/bag.png" alt="part image" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4 ab-content text-center p-lg-5 p-3 my-lg-5">
                    ...
                    <p>Lorem ipsum dolor sit,Nulla pellentesque dolor ipsum laoreet eleifend integer,Pellentesque
                        maximus libero.</p>
                    <a href="{{ url('shop') }}" class="btn shop mt-3">Shop Now</a>
        ...
        <div class="container py-md-5">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4 content-gd-wthree">
                    <img src="{{ url('public') }}/images/c1.jpg" class="img-fluid" alt="" />
                </div>
                ...
                <div class="col-md-4 content-gd-wthree">
                    <img src="{{ url('public') }}/images/c2.jpg" class="img-fluid" alt="" />
                </div>
            </div>
    ...
    <section class="mid-section">
        <div class="d-lg-flex p-0">
            <div class="col-lg-6 bottom-w3pvt-left p-lg-0">
                <img src="{{ url('public') }}images ab1.jpg" class="img-fluid" alt="" />
            ...
            <div class="col-lg-6 bottom-w3pvt-left bottom-w3pvt-right p-lg-0">
                <img src="{{ url('public') }}images ab2.jpg" class="img-fluid" alt="" />
                <div class="pos-w3pvt">
                ...
                <div class="col-lg-8 gallery-content">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 gal-img">
                            <a href="#gal1"><img src="{{ url('public') }}/images/g1.jpg" alt="Baggage"
                                    class="img-fluid mt-4"></a>
                        </div>
                        <div class="col-md-4 col-sm-6 gal-img">
                            <a href="#gal2"><img src="{{ url('public') }}/images/g2.jpg" alt="Baggage"
                                    class="img-fluid mt-4"></a>
                        </div>
                        <div class="col-md-4 col-sm-6 gal-img">
                            <a href="#gal3"><img src="{{ url('public') }}/images/g3.jpg" alt="Baggage"
                                    class="img-fluid mt-4"></a>
                        </div>
                        <div class="col-md-4 col-sm-6 gal-img">
                            <a href="#gal1"><img src="{{ url('public') }}/images/g4.jpg" alt="Baggage"
                                    class="img-fluid mt-4"></a>
                        </div>
                        <div class="col-md-4 col-sm-6 gal-img">
                            <a href="#gal2"><img src="{{ url('public') }}/images/g5.jpg" alt="Baggage"
                                    class="img-fluid mt-4"></a>
                        </div>
                        <div class="col-md-4 col-sm-6 gal-img">
                            <a href="#gal3"><img src="{{ url('public') }}/images/g6.jpg" alt="Baggage"
                                    class="img-fluid mt-4"></a>
                        </div>
                    ...
                    <div id="gal1" class="popup-effect">
                        <div class="popup">
                            <img src="{{ url('public') }}images/g1.jpg" alt="Popup image" class="img-fluid mt-4" />
                    ...
                    <div id="gal2" class="popup-effect">
                        <div class="popup">
                            <img src="{{ url('public') }}images/g2.jpg" alt="Popup image" class="img-fluid mt-4" />
                            <a class="close" href="#gallery">&times;</a>
                        </div>
                    </div>
                    <!-- //popup -->
                    ...
                    <div id="gal3" class="popup-effect">
                        <div class="popup">
                            <img src="{{ url('public') }}images/g3.jpg" alt="Popup image" class="img-fluid mt-4" />
                            <a class="close" href="#gallery">&times;</a>
                        </div>
                    </div>
                    <!-- //popup -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-4">
                    <ul class="footer_wthree_gridf_list">
                        <li>
                            <a href="{{ url('home') }}"><span class="fa fa-angle-right" aria-hidden="true"></span>
                                Home</a>
                        </li>
                        <li>
                            <a href="{ url('shop') }}"><span class="fa fa-angle-right" aria-hidden="true"></span>
                                Shop</a>
                        </li>
                        <li>
                            <a href="{{ url('product') }}"><span class="fa fa-angle-right"
                                    aria-hidden="true"></span>Product</a>
                        </li>
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-sm-4 mt-3">
                    <ul class="footer_wthree_gridf_list">
                        ...
                        <li>
                            <a href="{{ url('contact') }}"><span class="fa fa-angle-right"
                                    aria-hidden="true"></span> Contact</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 footer_wthree_gridf mt-md-0 mt-sm-4 mt-3">
                    <ul class="footer_wthree_gridf_list">
                        <li>
                            <a href="{{ url('login') }}"><span class="fa fa-angle-right" aria-hidden="true"></span>
                                Login
                            </a>
                        </li>

                        <li>
                            <a href="{{ url('register') }}"><span class="fa fa-angle-right"
                                    aria-hidden="true"></span>Register</a>
                        </li>
                        <li>
                            <a href="#"><span class="fa fa-angle-right" aria-hidden="true"></span>Privacy &
                                Policy</a>
                        </li>
